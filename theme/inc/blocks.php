    ...
    if ( $zuordnung && 'kreisverband' !== $zuordnung ) {
        ...
        $person_ids = get_posts(
            array(
				...
				'posts_per_page' => -1,
				'fields'         => 'ids',
				// phpcs:ignore WordPress.DB.SlowDBQuery.slow_db_query_tax_query -- The block editor picker must match the selected OV taxonomy.
				'tax_query'      => array(
					array(
