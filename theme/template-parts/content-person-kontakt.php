<?php
/**
 * Content person kontakt template.
 *
...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'clearfix' ); ?> role="article">
    ...
    <section class="entry-content">
        ...
        if ( $email ) :
			?>
            <p><i class="fas fa-envelope"></i> <a href="mailto:<?php echo esc_attr( $email ); ?>"><?php echo esc_html( $email ); ?></a></p><?php endif; ?>
        <?php
        if ( $telefon ) :
			?>
            <p><i class="fa fa-phone"></i> <?php echo esc_html( $telefon ); ?></p><?php endif; ?>
    </section>
</article>
