...
$meta = array(
    ...
    'details'     => get_post_meta( $gk_post_id, 'kr8mb_pers_pos_details', true ),
    ...
    'funktion2'   => get_post_meta( $gk_post_id, 'kr8mb_pers_funktion2', true ),
);
...
if ( 'personenliste' === $variant ) :
	...
	?>
<article class="gk-person gk-person--personenliste" id="post-<?php echo esc_attr( $gk_post_id ); ?>">
...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'gk-person gk-person--' . esc_attr( $variant ) . ' clearfix' ); ?> role="article">
    ...
    <?php if ( 'landesliste' === $variant && $meta['listenplatz'] ) : ?>
    ...
    <section class="entry-content">
        ...
        <?php if ( 'team' === $variant ) : ?>
            ...
            if ( $meta['email'] ) :
				?>
                <p><a href="mailto:<?php echo esc_attr( $meta['email'] ); ?>"><?php echo esc_html( $meta['email'] ); ?></a></p><?php endif; ?>
            <?php
            if ( $meta['telefon'] ) :
				?>
                <p><a href="tel:<?php echo esc_attr( $meta['telefon'] ); ?>"><?php echo esc_html( $meta['telefon'] ); ?></a></p><?php endif; ?>
        <?php endif; ?>

        <?php // Kontakt: email + telefon with icons. ?>
        <?php if ( 'kontakt' === $variant ) : ?>
            <?php
            if ( $meta['email'] ) :
				?>
                <p><i class="fas fa-envelope"></i> <a href="mailto:<?php echo esc_attr( $meta['email'] ); ?>"><?php echo esc_html( $meta['email'] ); ?></a></p><?php endif; ?>
            <?php
            if ( $meta['telefon'] ) :
				?>
                <p><i class="fa fa-phone"></i> <?php echo esc_html( $meta['telefon'] ); ?></p><?php endif; ?>
        <?php endif; ?>
        ...
        <?php if ( $show_details_link && 'yes' === $meta['details'] ) : ?>
